# Generated by Django 3.1 on 2021-10-22 20:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('F', 'Female'), ('M', 'Male'), ('O', 'Other')], max_length=6)),
                ('type', models.CharField(choices=[('AT', 'Athlete'), ('JU', 'Judge'), ('BO', 'Box owner')], max_length=9)),
